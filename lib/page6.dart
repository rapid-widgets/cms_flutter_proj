...
class _BoilerPlate extends State<BoilerPlate> {
  ...
  Widget build(BuildContext context) {
    ...
    TextParameters textparam4 = new TextParameters(
        text:
            'Order above 80 to save on delivery charges. Free delivery with cart value above USD 100',
        fontSize: 16,
    ...
    IconState icon8 =
        new IconState(icon: Icons.search, color: Colors.pink, size: 14);
                            ...
                            children: [
                              Expanded(
                                ...
                                child: customBorderlessCard(
                                    borderdata5, borderlessCallback5),
                              ),
                            ],
                          ),
                        ),
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 1,
                                child: customBorderlessCard(
                                    borderdata6, borderlessCallback6),
                              ),
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                flex: 1,
                                child: customisedIcon(icon8),
                              ),
                              Expanded(
                                flex: 2,
                                child: Align(
                                    alignment: Alignment.centerRight,
                                    child: customText(textparam9)),
                              ),
                            ],
                          ),
                        ),
