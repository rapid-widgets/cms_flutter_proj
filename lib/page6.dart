...
class _BoilerPlate extends State<BoilerPlate> {
  ...
  Widget build(BuildContext context) {
    ...
    TextParameters textparam0 = new TextParameters(
        text:
            'Order above 80 to save on delivery charges. Free delivery with cart value above 100',
        fontSize: 16,
    ...
    IconState icon5 = new IconState(
        icon: Icons.backspace_rounded, color: Color(0xffff0000), size: 20);
    ...
    onFlatButtonPress6(bool b) {
      ...
      Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) => Page8(3,
                  'https://run.mocky.io/v3/e2794ba4-3495-4d0c-bd20-74451ec83b25')));
    }
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 1,
                                child: customBorderlessCard(
                                    borderdata1, borderlessCallback1),
                              ),
                            ],
                          ),
                        ),
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 1,
                                child: customBorderlessCard(
                                    borderdata2, borderlessCallback2),
                              ),
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                flex: 1,
                                child: customisedIcon(icon5),
                              ),
                              Expanded(
                                flex: 2,
                                child: Align(
                                    alignment: Alignment.centerRight,
                                    child: customText(textparam4)),
                              ),
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 1,
                                child: customFlatButton(buttonFlatObject6,
                                    onFlatButtonPress6, onFlatButtonLongPress6),
                              ),
                            ],
                          ),
                        ),
