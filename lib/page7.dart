...
class _BoilerPlate extends State<BoilerPlate> {
  ...
  Widget build(BuildContext context) {
    ...
    TextParameters textparam32 = new TextParameters(
        text:
            'Your card details will be stored securely for your convenience. We do not store CVV.',
        fontSize: 14,
        textColor: Colors.pink,
        fontStyle: FontStyle.normal,
        fontFamily: 'Roboto',
    ...
    onFlatButtonPress33(bool b) {
      ...
      Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) => Page8(1,
                  'https://run.mocky.io/v3/96d9ffcf-53df-4002-888d-f1ddb3b651a4')));
    }
                      ...
                      children: <Widget>[
                            ...
                            children: [
                              Expanded(
                                ...
                                child: CustomTextField(
                                    params: finalTextObj16,
                                    callbackTextfield: onTextSubmit16),
                              ),
                              Spacer(flex: 1),
                              Expanded(
                                flex: 1,
                                child: CustomImage(data: ImageObj117),
                              ),
                            ],
                          ),
                        ),
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 8,
                                child: CustomTextField(
                                    params: finalTextObj20,
                                    callbackTextfield: onTextSubmit20),
                              ),
                              Spacer(
                                flex: 1,
                              ),
                              Expanded(
                                flex: 8,
                                child: CustomTextField(
                                    params: finalTextObj21,
                                    callbackTextfield: onTextSubmit21),
                              ),
                              Spacer(
                                flex: 1,
                              ),
                              Expanded(
                                flex: 1,
                                child: CustomImage(data: ImageObj122),
                              ),
                            ],
                          ),
                        ),
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 3,
                                child: CustomTextField(
                                    params: finalTextObj24,
                                    callbackTextfield: onTextSubmit24),
                              ),
                              Spacer(flex: 1)
                            ],
                          ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                  flex: 1, child: CustomCheckBox(checkparam)),
                              Expanded(flex: 6, child: customText(textparam26)),
                              Spacer(flex: 3)
                            ],
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 1,
                                child: CustomImage(data: ImageObj128),
                              ),
                              Expanded(
                                flex: 1,
                                child: CustomImage(data: ImageObj129),
                              ),
                              Expanded(
                                flex: 1,
                                child: CustomImage(data: ImageObj130),
                              ),
                              Expanded(
                                flex: 1,
                                child: CustomImage(data: ImageObj131),
                              ),
                              Spacer(flex: 4)
                            ],
                          ),
