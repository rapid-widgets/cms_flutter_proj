          ...
          child: Column(
            children: <Widget>[
              Align(
                  ...
                  child: Image.network(
                    'http://104.40.75.137:9003/assets/medical/image41.png ',
                    height: 102,
                    width: 65,
                  )),
              SizedBox(
          ...
          child: Column(
            children: <Widget>[
              ...
              Align(
                ...
                child: Text(
                  'Cardiologist, Chief of Intrevention Cardiology Center - Gold Medalist',
          ...
          child: Column(
            children: <Widget>[
              Align(
                  alignment: Alignment.centerRight,
                  child: Image.network(
                    'http://104.40.75.137:9003/assets/medical/image42.png',
                    height: 102,
                    width: 65,
                  )),
              SizedBox(
          ...
          child: Column(
            children: <Widget>[
              Align(
                  alignment: Alignment.centerRight,
                  child: Image.network(
                    'http://104.40.75.137:9003/assets/medical/image43.png',
                    height: 102,
                    width: 65,
                  )),
              SizedBox(
          ...
          child: Column(
            children: <Widget>[
              Align(
                  alignment: Alignment.centerRight,
                  child: Image.network(
                    'http://104.40.75.137:9003/assets/medical/image44.png',
                    height: 102,
                    width: 65,
                  )),
              SizedBox(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 1,
                                child: compositeCard(listcards1),
                              ),
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 1,
                                child: compositeCard(listcards2),
                              ),
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 1,
                                child: compositeCard(listcards3),
                              ),
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 1,
                                child: compositeCard(listcards4),
                              ),
                            ],
                          ),
                        ),
